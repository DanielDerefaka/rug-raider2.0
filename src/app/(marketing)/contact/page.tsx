...
import { FeaturedTestimonials } from "@/components/shared/featured-testimonials";
import { cn } from "@/lib/utils";
import { HorizontalGradient } from "@/components/shared/horizontal-gradient";
import { ContactForm } from "@/components/shared/contact";

export const metadata: Metadata = {
  title: "Contact Us - Rug Raider",
  description:
      ...
      <div className="w-full min-h-screen grid grid-cols-1 md:grid-cols-2 relative overflow-hidden">
        ...
        <div className="relative w-full z-20 hidden md:flex border-l border-neutral-100 dark:border-neutral-900 overflow-hidden bg-gray-50 dark:bg-black items-center justify-center">
          <div className="max-w-sm mx-auto">
            ...
            >
              Rug Raideris used by thousands of users
            </p>
            <p
              className={cn(
            ...
            >
              With lots of AI applications around, Rug Raider stands out with
