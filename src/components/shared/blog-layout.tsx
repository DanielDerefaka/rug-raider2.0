...
import { BlogWithSlug } from "@/lib/notion";
      ...
      <div className="xl:relative">
        <div className="mx-auto max-w-2xl">
          <article className="pb-8">
            ...
            <div
              className="mt-8  
              prose-lg prose-headings:text-zinc-100 prose-p:text-zinc-300 
          prose-a:text-blue-400 hover:prose-a:text-blue-300
          prose-strong:text-zinc-200 prose-code:text-zinc-200
          prose-pre:bg-zinc-900 prose-pre:border prose-pre:border-zinc-800
          prose-blockquote:border-l-zinc-700 prose-blockquote:text-zinc-400
          prose-li:text-zinc-300 prose-table:text-zinc-300
