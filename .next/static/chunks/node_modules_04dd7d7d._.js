...
"[project]/node_modules/@ledgerhq/devices/lib-es/hid-framing.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function asUInt16BE(value) {
    const b = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].alloc(2);
 ...
 */ const createHIDframing = (channel, packetSize)=>{
    return {
         ...
         */ makeBlocks (apdu) {
            ...
            let data = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].concat([
            ...
            data = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].concat([
                data,
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].alloc(nbBlocks * blockSize - data.length + 1).fill(0)
            ]);
            const blocks = [];
            for(let i = 0; i < nbBlocks; i++){
                const head = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].alloc(5);
                head.writeUInt16BE(channel, 0);
                head.writeUInt8(Tag, 2);
                head.writeUInt16BE(i, 3);
                // `slice` and not `subarray`: this might not be a Node Buffer, but probably only a Uint8Array
                const chunk = data.slice(i * blockSize, (i + 1) * blockSize);
                blocks.push(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].concat([
                    head,
                    chunk
                ]));
            }
         ...
         */ reduceResponse (acc, chunk) {
            ...
            if (chunk.readUInt16BE(0) !== channel) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ledgerhq$2f$errors$2f$lib$2d$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["TransportError"]("Invalid channel", "InvalidChannel");
            }
            if (chunk.readUInt8(2) !== Tag) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ledgerhq$2f$errors$2f$lib$2d$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["TransportError"]("Invalid tag", "InvalidTag");
            }
            if (chunk.readUInt16BE(3) !== sequence) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ledgerhq$2f$errors$2f$lib$2d$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["TransportError"]("Invalid sequence", "InvalidSequence");
            }
...
"[project]/node_modules/@ledgerhq/devices/lib-es/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const devices = {
    ...
    [DeviceModelId.nanoS]: {
        ...
        getBlockSize: (firmwareVersion)=>{
            var _a;
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$semver$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].lt((_a = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$semver$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].coerce(firmwareVersion)) !== null && _a !== void 0 ? _a : "", "2.0.0") ? 4 * 1024 : 2 * 1024;
        }
    },
    [DeviceModelId.nanoX]: {
...
"[project]/node_modules/@ledgerhq/hw-transport-webhid/lib-es/TransportWebHID.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ledgerhq$2f$devices$2f$lib$2d$es$2f$hid$2d$framing$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@ledgerhq/devices/lib-es/hid-framing.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ledgerhq$2f$devices$2f$lib$2d$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@ledgerhq/devices/lib-es/index.js [app-client] (ecmascript)");
...
const ledgerDevices = [
    {
        vendorId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ledgerhq$2f$devices$2f$lib$2d$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ledgerUSBVendorId"]
    }
];
...
const getHID = ()=>{
    // $FlowFixMe
    const { hid } = navigator;
    if (!hid) throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ledgerhq$2f$errors$2f$lib$2d$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["TransportError"]("navigator.hid is not supported", "HIDNotSupported");
    return hid;
};
...
function getLedgerDevices() {
    return __awaiter(this, void 0, void 0, function*() {
        ...
        return devices.filter((d)=>d.vendorId === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ledgerhq$2f$devices$2f$lib$2d$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ledgerUSBVendorId"]);
    });
}
 ...
 */ class TransportWebHID extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ledgerhq$2f$hw$2d$transport$2f$lib$2d$es$2f$Transport$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"] {
    constructor(device){
        super();
        ...
        this.onInputReport = (e)=>{
            const buffer = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(e.data.buffer);
         ...
         */ this.exchange = (apdu)=>__awaiter(this, void 0, void 0, function*() {
                const b = yield this.exchangeAtomicImpl(()=>__awaiter(this, void 0, void 0, function*() {
                        ...
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ledgerhq$2f$logs$2f$lib$2d$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"])("apdu", "=> " + apdu.toString("hex"));
                        const framing = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ledgerhq$2f$devices$2f$lib$2d$es$2f$hid$2d$framing$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(channel, packetSize);
                        // Write...
                        ...
                        while(!(result = framing.getReducedResult(acc))){
                            try {
                                ...
                                if (e instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ledgerhq$2f$errors$2f$lib$2d$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["TransportError"] && e.id === "InvalidChannel") {
                                    continue;
                                }
                                throw e;
                            }
                        }
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ledgerhq$2f$logs$2f$lib$2d$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"])("apdu", "<= " + result.toString("hex"));
                        return result;
                    })).catch((e)=>{
                    if (e && e.message && e.message.includes("write")) {
                        this._emitDisconnect(e);
                        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ledgerhq$2f$errors$2f$lib$2d$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DisconnectedDeviceDuringOperation"](e.message);
                    }
                    throw e;
                });
                return b;
        ...
        this.device = device;
        this.deviceModel = typeof device.productId === "number" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ledgerhq$2f$devices$2f$lib$2d$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["identifyUSBProductId"])(device.productId) : undefined;
        ...
        return __awaiter(this, void 0, void 0, function*() {
            ...
            const onDisconnect = (e)=>{
                if (device === e.device) {
                    ...
                    transport._emitDisconnect(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ledgerhq$2f$errors$2f$lib$2d$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DisconnectedDevice"]());
                }
            };
 ...
 */ TransportWebHID.listen = (observer)=>{
    ...
    getFirstLedgerDevice().then((device)=>{
        if (!device) {
            observer.error(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ledgerhq$2f$errors$2f$lib$2d$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["TransportOpenUserCancelled"]("Access denied to use Ledger device"));
        } else if (!unsubscribed) {
            const deviceModel = typeof device.productId === "number" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ledgerhq$2f$devices$2f$lib$2d$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["identifyUSBProductId"])(device.productId) : undefined;
            observer.next({
                type: "add",
                descriptor: device,
                deviceModel
        ...
        observer.error(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ledgerhq$2f$errors$2f$lib$2d$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["TransportOpenUserCancelled"](error.message));
    });
...
//# sourceMappingURL=node_modules_04dd7d7d._.js.map